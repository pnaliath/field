...
fixes = [
    ...
    (
        ...
        '''    "One FL-native instance. Routed mixer tracks become live spectral bodies; names, colors and audio update from FL Studio.",''',
    ),
]

for old, new in fixes:
    if old not in code:
        raise RuntimeError(f"Could not find V0.06 generator patch literal: {old[:80]}")
